...
// Stripe removed - using Zelle/Cash App payments only
console.log('Using Zelle/Cash App payment system - Stripe disabled');
...
// Routes
app.get("/", (req, res) => {
  res.json({ message: "Sweets by Bella Backend API - Zelle/Cash App Payment System" });
});
...
if (process.env.NODE_ENV !== "production" || !process.env.VERCEL) {
  app.listen(PORT, () => {
    ...
    console.log(`🍪 Using Zelle/Cash App payment system`);
  });
}
